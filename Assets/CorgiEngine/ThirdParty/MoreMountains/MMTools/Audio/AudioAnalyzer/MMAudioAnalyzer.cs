...
namespace MoreMountains.Tools
{
    ...
    public class MMAudioAnalyzer : MonoBehaviour
	{
        ...
        [Header("Source")]
        [Information("This component lets you pick an audio source (either global : the whole scene's audio, a unique source, or the " +
            ...
            "fast buffered band levels readjust.", MoreMountains.Tools.InformationAttribute.InformationType.Info, false)]
        [ReadOnlyWhenPlaying]
        ...
        [Dropdown(2,4,8,16,32,64,128,256,512,1024,2048,4096,8192)]
        [ReadOnlyWhenPlaying]
