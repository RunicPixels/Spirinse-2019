...
namespace MoreMountains.Tools
{
    ...
    public class MMCountdown : MonoBehaviour
    {
        ...
        [Header("Countdown")]
        [Information("You can define the bounds of the countdown (how much it should count down from, and to how much, the format it should be displayed in (standard Unity float ToString formatting).", MoreMountains.Tools.InformationAttribute.InformationType.Info, false)]
        ...
        [Information("You can choose whether or not the countdown should automatically start on its Start, at what frequency (in seconds) it should refresh (0 means every frame), and the countdown's speed multiplier " +
            ...
            "Bind events here to trigger them when the countdown reaches its To destination, or every time it gets refreshed.", MoreMountains.Tools.InformationAttribute.InformationType.Info, false)]
