...
Shader "Ronald/CorruptShader"
{
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			output.__rampThreshold = ( _RampThreshold1 );
			output.__rampSmoothing = ( _RampSmoothing1 );
			output.__highlightColor = ( _HColor1.rgb );
			output.__shadowColor = ( _SColor1.rgb );
